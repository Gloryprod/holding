  ...
  const stats = [
    {
      ...
      numericValue: data.nombre_projets ? data.nombre_projets : 0,
      suffix: "+",
      icon: CheckCircle2,
    },
    {
      ...
      numericValue: data.nombre_beneficiaires ? data.nombre_beneficiaires : 0,
      suffix: "",
      icon: Users,
    },
    {
      ...
      numericValue: data.nombre_annees_experience ? data.nombre_annees_experience : 0,
      suffix: "",
      icon: Calendar,
    },
    {
